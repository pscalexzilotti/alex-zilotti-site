  ...
  return (
    <footer style={{ background: "var(--deep)", borderTop: "1px solid rgba(154,128,96,0.08)" }}>
      <div className="ft-g" style={{
        ...
        <div>
          <div style={{
            ...
            }}>Psicologo Â· CRP 08/48529</small>
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <p style={{ fontSize: "0.78rem", color: "var(--stone)" }}>Curitiba Â· Parana</p>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "0.65rem", color: "var(--muted)", letterSpacing: "0.05em" }}>2025 Alex Zilotti Â· Todos os direitos reservados</p>
        <p style={{ fontSize: "0.65rem", color: "var(--muted)", letterSpacing: "0.05em" }}>Psicologo Juridico Â· Psicologo Forense Â· Alta Performance</p>
      </div>
