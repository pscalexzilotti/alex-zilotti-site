...
function ContactOption({
  ...
  return (
    ...
    >
      <div style={{ color: hovered ? 'var(--glt)' : 'var(--gold)', transition: 'color 0.3s' }}>{icon}</div>
      <h5 style={{
        fontFamily: 'var(--font-cormorant), Georgia, serif',
        fontSize: '1.2rem', fontWeight: 300, color: 'var(--warm)',
      }}>{title}</h5>
      <p style={{ fontSize: '0.75rem', color: 'var(--stone)', textAlign: 'center' }}>{subtitle}</p>
    </a>
  )
}
      ...
      <div style={{ maxWidth: 580, margin: '0 auto', textAlign: 'center' }}>
        ...
        <RevealWrapper delay={0.1}>
          <h2 style={{
            ...
            color: 'var(--warm)', letterSpacing: '-0.01em', marginBottom: 24,
          }}>
            O prÃ³ximo passo comeÃ§a com{' '}
        ...
        <RevealWrapper delay={0.2}>
          <p style={{ fontSize: '0.88rem', color: 'var(--stone)', lineHeight: 1.9, marginBottom: 56 }}>
            Atendimento por agendamento. Confidencialidade garantida. Sem formulÃ¡rios impessoais
            â€” apenas um contato direto, discreto e sem compromisso.
          </p>
        </RevealWrapper>
        ...
        <RevealWrapper delay={0.3}>
          <div style={{
            ...
            gap: 2, background: 'rgba(154,128,96,0.07)', marginBottom: 40,
          }}>
            <ContactOption
              href="https://wa.me/554199176772"
              external
              title="WhatsApp"
              subtitle="Resposta rÃ¡pida e direta"
              icon={
            ...
            <ContactOption
              ...
              title="E-mail"
              subtitle="Para demandas mais detalhadas"
              icon={
        ...
        <RevealWrapper delay={0.4}>
          <p style={{ fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--muted)' }}>
            DiscriÃ§Ã£o total Â· Sigilo garantido Â· Atendimento premium
          </p>
        </RevealWrapper>
      </div>
    </section>
