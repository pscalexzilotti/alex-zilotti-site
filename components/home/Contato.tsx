      ...
      <div style={{ maxWidth: 580, margin: '0 auto', textAlign: 'center' }}>
        ...
        <RevealWrapper delay={0.2}>
          <p style={{ fontSize: '0.88rem', color: 'var(--stone)', lineHeight: 1.9, marginBottom: 56 }}>
            Atendimento por agendamento. Confidencialidade garantida. Sem formulários impessoais
            — apenas um contato direto, discreto e sem compromisso.
          </p>
        </RevealWrapper>
        ...
        <RevealWrapper delay={0.3}>
          <div style={{
            ...
            <ContactOption
              ...
              external
              title="WhatsApp"
              subtitle="Resposta rápida e direta"
              icon={
        ...
        <RevealWrapper delay={0.4}>
          <p style={{ fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--muted)' }}>
            Discrição total · Sigilo garantido · Atendimento premium
          </p>
        </RevealWrapper>
      </div>
    </section>
